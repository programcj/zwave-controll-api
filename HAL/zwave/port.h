/* 漏 2014 Sigma Designs, Inc. This is an unpublished work protected by Sigma
 ...
 * anyone except Licensees of Sigma Designs  who have executed a Sigma Designs鈥� * Z-WAVE CONTROLLER DEVELOPMENT KIT LIMITED LICENSE AGREEMENT. The copyright
 ...
 * COMPANY鈥橲 NEEDS AND COMPANY鈥橲 USE OF THE SIGMA PROGRAM IS AT COMPANY鈥橲
 * OWN DISCRETION AND RISK. SIGMA DOES NOT GUARANTEE THAT THE USE OF THE SIGMA
 * PROGRAM IN A THIRD PARTY SERVICE ENVIRONMENT OR CLOUD SERVICES ENVIRONMENT WILL
 * BE: (A) PERFORMED ERROR-FREE OR UNINTERRUPTED; (B) THAT SIGMA WILL CORRECT ANY
 * THIRD PARTY SERVICE ENVIRONMENT OR CLOUD SERVICE ENVIRONMENT ERRORS; (C) THE
 * THIRD PARTY SERVICE ENVIRONMENT OR CLOUD SERVICE ENVIRONMENT WILL OPERATE IN
 * COMBINATION WITH COMPANY鈥橲 CONTENT OR COMPANY APPLICATIONS THAT UTILIZE THE
 ...
 * Activities.Without limiting Sigma鈥檚 obligation of confidentiality as further
 * described in the Z-Wave Controller Development Kit Limited License Agreement,
 * Sigma has no obligation to establish and maintain a data privacy and
 * information security program with regard to Company鈥檚 use of any Third Party
